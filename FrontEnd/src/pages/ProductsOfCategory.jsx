...
export default function ProductList() {
    ...
    const categoryName = categories?.find(cat => cat._id === category)?.name?.[language] || categories?.find(cat => cat._id === category)?.name?.en || t('allProducts');
    ...
    }, [dispatch, category, pagination.page]);
